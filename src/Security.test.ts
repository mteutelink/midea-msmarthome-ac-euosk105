...
describe('Security', () => {
	it('aesEncrypt', () => {
		...
		let result = Security.aesEncrypt(Buffer.from(input, 'hex'));
	...
	it('aesDecrypt', () => {
		...
		let result = Security.aesDecrypt(Buffer.from(input, 'hex'));
		expect(result.toString('hex')).toEqual(expected);
	})
	it('aesCbcEncrypt', () => {
		...
		let result = Security.aesCbcEncrypt(Buffer.from(input, 'hex'), Buffer.from(key, 'hex'));
		expect(result.toString('hex')).toEqual(expected);
	})
	it('aesCbcDecrypt', () => {
	...
	it('encode32', () => {
		...
		let result = Security.encode32(Buffer.from(input, 'hex'));
		expect(result.toString('hex')).toEqual(expected);
	})
	it('encode8370', () => {
